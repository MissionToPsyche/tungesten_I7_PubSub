...
function UpdateUser() {
	...
	var [showDateOfBirthError, setDateOfBirthErrorFlag] = useState(false);
	var [fullNameErrorMessage, setFullNameErrorMessage] = useState('');
	var [emailErrorMessage, setEmailErrorMessage] = useState('');
	var [dateOfBirthErrorMessage, setDateOfBirthErrorMessage] = useState('');
				...
				<Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
					...
					<Box component="form" noValidate sx={{ mt: 1 }}>
						...
						<LocalizationProvider fullWidth margin="normal" dateAdapter={AdapterDayjs}>
							<DatePicker sx={{ width: 396, marginTop: 2 }} fullWidth required margin="normal" label="Date of Birth" disableFuture />
						</LocalizationProvider>
						{/* <TextField value={dateOfBirth} margin="normal" onChange={dateOfBirthChanged} error={showDateOfBirthError} required fullWidth name="date" helperText={dateOfBirthErrorMessage} label="Date of Birth" type="date" id="date" /> */}
